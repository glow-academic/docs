...
const tables = [
  ...
  `CREATE TABLE IF NOT EXISTS oauth_application (id TEXT PRIMARY KEY, name TEXT, icon TEXT, metadata TEXT, clientId TEXT, clientSecret TEXT, redirectURLs TEXT, type TEXT, disabled INTEGER, userId TEXT, createdAt TEXT, updatedAt TEXT)`,
  `CREATE TABLE IF NOT EXISTS oauth_access_token (id TEXT PRIMARY KEY, accessToken TEXT, refreshToken TEXT, accessTokenExpiresAt TEXT, refreshTokenExpiresAt TEXT, clientId TEXT, userId TEXT, scopes TEXT, createdAt TEXT, updatedAt TEXT)`,
  `CREATE TABLE IF NOT EXISTS oauth_consent (id TEXT PRIMARY KEY, clientId TEXT, userId TEXT, scopes TEXT, consentGiven INTEGER, createdAt TEXT, updatedAt TEXT)`,
  `CREATE TABLE IF NOT EXISTS oauth_authorization_code (id TEXT PRIMARY KEY, code TEXT, clientId TEXT, userId TEXT, redirectURI TEXT, scopes TEXT, expiresAt TEXT, codeChallenge TEXT, codeChallengeMethod TEXT, createdAt TEXT, updatedAt TEXT)`,
];
