{/* DEMO_VIDEO: index-overview | playwright */}
...
<DemoVideo topic="index-overview" kind="playwright" caption="Glow in 60 seconds — landing on the docs home and orienting around what the platform does." />
...
- **[Authentication](/authentication)** — sessions and bearer tokens
