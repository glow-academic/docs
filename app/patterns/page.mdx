{/* DEMO_VIDEO: patterns-overview | playwright */}

# Patterns & Best Practices

<DemoVideo topic="patterns-overview" kind="playwright" caption="Quick tour through the pattern catalog — persona realism, rubric specificity, parameters, progressive difficulty." />
...
{/* DEMO_VIDEO: patterns-persona-realism | playwright */}
...
{/* DEMO_VIDEO: patterns-rubric-criteria | playwright */}
...
```bash
curl -X POST $GLOW_INSTANCE_URL/<art>/draft \
