{/* DEMO_VIDEO: tutorial-overview | playwright */}

# Design Your First Simulation

<DemoVideo topic="tutorial-overview" kind="playwright" caption="The full tutorial path end-to-end: rubric, four personas, four scenarios, one simulation, cohort assignment." />
