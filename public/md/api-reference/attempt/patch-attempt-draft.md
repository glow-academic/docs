...
| `images` | [`app__infra__chat__types__DraftImageValue`](/api-reference/attempt/types#app-infra-chat-types-draftimagevalue)[] | No | — |
| `image_ids` | `string`[] | No | — |
| `videos` | [`app__infra__chat__types__DraftVideoValue`](/api-reference/attempt/types#app-infra-chat-types-draftvideovalue)[] | No | — |
| `video_ids` | `string`[] | No | — |
| `questions` | [`app__infra__chat__types__DraftQuestionValue`](/api-reference/attempt/types#app-infra-chat-types-draftquestionvalue)[] | No | — |
| `question_ids` | `string`[] | No | — |
| `options` | [`app__infra__chat__types__DraftOptionValue`](/api-reference/attempt/types#app-infra-chat-types-draftoptionvalue)[] | No | — |
