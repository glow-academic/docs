...
| `groups` | [`ArtifactSessionGroup-Output`](/api-reference/session/types#artifactsessiongroup-output)[] | No | Groups in the session |
| `timeline` | [`SessionTimelineItem`](/api-reference/session/types#sessiontimelineitem)[] | No | Timeline events for the session |