...
| `evals` | [`ListEvalApiEval`](/api-reference/evals/types#listevalapieval)[] | No | List of evals |
| `department_filter` | [`ListFilterSection`](/api-reference/evals/types#listfiltersection) | No | Filter options for departments in list UI |
