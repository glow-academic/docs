...
| Field | Type | Required | Description |
|---|---|---|---|
| `sections` | [`ReportsSections`](/api-reference/reports/types#reportssections) | No | Computed report sections |
| `views` | [`ReportsViews`](/api-reference/reports/types#reportsviews) | No | Raw MV view slices (deprecated) |
| `resources` | [`ReportsResources`](/api-reference/reports/types#reportsresources) | No | Resource metadata for hydration |
| `total_count` | `integer` | No | Total number of matching records |
| `simulation_options` | [`FilterOption`](/api-reference/reports/types#filteroption)[] | No | Simulation filter options |
| `profile_options` | [`FilterOption`](/api-reference/reports/types#filteroption)[] | No | Profile filter options |
| `scenario_options` | [`FilterOption`](/api-reference/reports/types#filteroption)[] | No | Scenario filter options |
| `analytics` | [`AnalyticsFacets-Output`](/api-reference/reports/types#analyticsfacets-output) | No | Inline analytics facets for SSR |