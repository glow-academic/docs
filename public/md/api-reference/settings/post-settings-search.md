...
| `settings` | [`ListSettingApiSetting`](/api-reference/settings/types#listsettingapisetting)[] | No | List of setting items |
| `keys` | [`ListSettingApiKey`](/api-reference/settings/types#listsettingapikey)[] | No | List of key items |