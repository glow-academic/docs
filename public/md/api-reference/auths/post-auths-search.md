...
| `auths` | [`ListAuthApiAuth`](/api-reference/auths/types#listauthapiauth)[] | No | List of auth provider items |
| `department_filter` | [`ListFilterSection`](/api-reference/auths/types#listfiltersection) | No | Filter options for departments |
