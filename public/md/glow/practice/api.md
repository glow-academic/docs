...
| `items` | [`ChatSimulationOperational`](#chatsimulationoperational)[] | No | Available practice simulation cards |
...
### `POST` `/practice/export`

Export Practice

Export all practice data as a clean, denormalized ZIP.

**Response** (`ExportPracticeApiResponse`):
