...
| `items` | [`ChatSimulationOperational`](#chatsimulationoperational)[] | No | Available simulation cards |
| `rubrics` | [`RubricMapping`](#rubricmapping)[] | No | Rubric mapping data |
| `standard_groups` | [`StandardGroupMapping`](#standardgroupmapping)[] | No | Standard group mapping data |
| `standards` | [`StandardMapping`](#standardmapping)[] | No | Standard mapping data |
