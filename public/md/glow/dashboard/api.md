...
**Response** (`ExportDashboardApiResponse`):
...
| Field | Type | Required | Description |
|---|---|---|---|
| `header_metrics` | [`DashboardHeaderMetrics-Input`](#dashboardheadermetrics-input) | No | Header summary metrics |
| `primary_metrics` | [`DashboardPrimaryMetrics-Input`](#dashboardprimarymetrics-input) | No | Primary dashboard metrics |
| `secondary_metrics` | [`DashboardSecondaryMetrics-Input`](#dashboardsecondarymetrics-input) | No | Secondary dashboard metrics |
| `footer_metrics` | [`DashboardFooterMetrics-Input`](#dashboardfootermetrics-input) | No | Footer dashboard metrics |
| `simulations` | [`DashboardSimulationMeta`](#dashboardsimulationmeta)[] | No | Simulation metadata list |
| `scenarios` | [`DashboardScenarioMeta`](#dashboardscenariometa)[] | No | Scenario metadata list |
| `rubrics` | [`DashboardRubricMeta`](#dashboardrubricmeta)[] | No | Rubric metadata list |
| `parameters` | [`DashboardParameterMeta`](#dashboardparametermeta)[] | No | Parameter metadata list |
