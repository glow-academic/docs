...
{/* DEMO_VIDEO: authentication — replace public/demos/authentication.mp4 */}
...
<DemoVideo topic="authentication" caption="OAuth round-trip: glow login → browser → callback → token stored." />
