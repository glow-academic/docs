...
{/* DEMO_VIDEO: session-overview — replace public/demos/session-overview.mp4 */}
...
{/* DEMO_VIDEO: session-detail-view — replace public/demos/session-detail-view.mp4 */}
...
{/* DEMO_VIDEO: session-timeline — replace public/demos/session-timeline.mp4 */}
...
{/* DEMO_VIDEO: session-navigate-to-group — replace public/demos/session-navigate-to-group.mp4 */}
